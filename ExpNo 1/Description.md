...
<h3>Name: Sharmila A</h3>
<h3>Register Number : 212221230094</h3>
<H3>Aim:</H3>
...
return path graph=defaultdict(list)
n,e=map(int,input().split())
for i in range(e):
u,v=map(str,input().split()) graph[u].append(v) graph[v].append(u)
#print(graph)
start=000 2
visited=defaultdict(bool)
path=[] traversedpath=dfs(graph,start,visited,path)
print(traversedpath) `
```
<hr>
<h3>Sample Input</h3>
...
![image](https://github.com/Sharmilasha/19AI405FUNDAMENTALSOFARTIFICIALINTELLIGENCE/assets/94506182/fb0a191e-381e-4a5a-abb1-b8a5dd0ac702)
